...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("50943471470")
...
module.exports = {
  ...
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY 𝑺𝒕𝒆𝒆𝒇 𝑳𝒆 𝑴𝒆𝒈𝒂𝒍𝒐𝒅𝒐𝒏 ❟❛❟* 🎊',
  ownername:process.env.OWNER_NAME || '𝑺𝒕𝒆𝒆𝒇 𝑳𝒆 𝑴𝒆𝒈𝒂𝒍𝒐𝒅𝒐𝒏 ❟❛❟',
  sessionName: process.env.SESSION_ID || 'PRABATH-MD~guFizSTK#qbm7ksmgbM7783pDV7WcT-1T-O_nWOczyV9HhabHXgU',
  author: process.env.PACK_INFO.split(";")[0] || '𝑺𝒕𝒆𝒆𝒇 𝑳𝒆 𝑴𝒆𝒈𝒂𝒍𝒐𝒅𝒐𝒏 ❟❛❟', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'true',
  packname: process.env.PACK_INFO.split(";")[1] || '𝑺𝒕𝒆𝒆𝒇 𝑳𝒆 𝑴𝒆𝒈𝒂𝒍𝒐𝒅𝒐𝒏 ❟❛❟',
  ...
  BRANCH: 'main',
  ALIVE_MESSAGE: process.env.ALIVE_MESSAGE || 'Alive 😊',
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || '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',
